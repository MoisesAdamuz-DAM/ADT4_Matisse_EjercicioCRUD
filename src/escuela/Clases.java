...
public class Clases extends com.matisse.reflect.MtObject {
    ...
    private static int CID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtClass.Loader("escuela.Clases"));
     ...
     */
    public final escuela.Profesores[] getImpartidas_por() {
        return (escuela.Profesores[])getSuccessors(getImpartidas_porRelationship(getMtDatabase()), escuela.Profesores.class);
    }
    ...
    public final <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> impartidas_porIterator() {
        return this.<E>successorIterator(getImpartidas_porRelationship(getMtDatabase()), escuela.Profesores.class);
    }
     ...
     * @see #removeImpartidas_por
     */
    public final void setImpartidas_por(escuela.Profesores[] succs) {
     ...
     * @see #removeImpartidas_por
     */
    public final void prependImpartidas_por(escuela.Profesores succ) {
     ...
     * @see #impartidas_porIterator
     */
    public final void appendImpartidas_por(escuela.Profesores succ) {
     ...
     * @see #impartidas_porIterator
     */
    public final void appendImpartidas_por(escuela.Profesores[] succs) {
     ...
     * @see #impartidas_porIterator
     */
    public void removeImpartidas_por(escuela.Profesores[] succs) {
     ...
     * @see #impartidas_porIterator
     */
    public void removeImpartidas_por(escuela.Profesores succ) {
