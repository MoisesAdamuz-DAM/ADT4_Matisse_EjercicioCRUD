 ...
 */
public class Asignaturas extends escuela.Clases {
    ...
    private static int CID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtClass.Loader("escuela.Asignaturas"));
